...
class DataParser {
  ...
  incoming(msgBUF) {
    ...
    ///// LARGE messages (2^16 < bytes <= 2^64) /////
      ...
      dbg = 'Large message';
      const byte3and4 = msgBUF.readUInt16BE(2);
      const byte5and6 = msgBUF.readUInt16BE(4);
      const byte7and8 = msgBUF.readUInt16BE(6);
      const byte9and10 = msgBUF.readUInt16BE(8);
      byte_3_10 = Buffer.concat([byte3and4, byte5and6, byte7and8, byte9and10]);
